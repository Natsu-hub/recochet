...
function slide() {
  window.addEventListener('DOMContentLoaded', function () {
    ...
    for (var i = 0; i < splideElements.length; i++) {
      new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__.Splide(splideElements[i]).mount();
    }

    //FVの流れる人物画像
    if (document.querySelector(".js-slide-img")) {
      var slideImgMv = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__.Splide(".js-slide-img", {
