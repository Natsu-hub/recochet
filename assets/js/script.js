...
function animation() {
  window.addEventListener('DOMContentLoaded', function () {
    ...
    //   );
    // });
    var fadeInSlowElements = document.querySelectorAll(".js-fadeInSlow");
    fadeInSlowElements.forEach(function (element) {
      // 画面の幅をチェックして適切なディレイを設定
      var delayValue = window.innerWidth >= 768 ? .7 : 0;
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(element, {
        autoAlpha: 0,
        y: 10
      }, {
    ...
    window.addEventListener('resize', function () {
      fadeInSlowElements.forEach(function (element) {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.killTweensOf(element);
    ...
    var fadeInSlowerElements = document.querySelectorAll(".js-fadeInSlower");
    fadeInSlowerElements.forEach(function (element) {
      // 画面の幅をチェックして適切なディレイを設定
      var delayValue = window.innerWidth >= 768 ? 1.5 : 0;
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(element, {
        autoAlpha: 0,
        y: 10
      }, {
    ...
    // フェードインアニメーション02
    var fadeIn02Elements = document.querySelectorAll(".js-fadeIn");
    fadeIn02Elements.forEach(function (element) {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(element, {
        autoAlpha: 0
      }, {
        autoAlpha: 1,
    ...
    // フェードインアニメーションbody
    var fadeInBodyElements = document.querySelectorAll(".js-fadeBodyIn");
    fadeInBodyElements.forEach(function (element) {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(element, {
        autoAlpha: 0
      }, {
        autoAlpha: 1,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "contactFrom": () => (/* binding */ contactFrom)
/* harmony export */ });
...
function header() {
  ...
  function closeDrawer() {
    setTimeout(function () {
      ...
      // アニメーションを削除
      var items = document.querySelectorAll('.js-nav-list');
...
function img() {
  window.addEventListener('DOMContentLoaded', function () {
    ...
    /* initial */
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set('.js-img', {
      autoAlpha: 0
    });
    ...
    var items = document.querySelectorAll('.p-service-list__item');
    items.forEach(function (item, index) {
      var image = item.querySelector('.js-img');
      var texts = item.querySelectorAll('.js-move-text');

      // 画面の幅をチェックして適切なディレイを設定
      var delayValue = window.innerWidth >= 768 ? index === 1 ? 0.7 : 0 : 0;
      gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.create({
        ...
        onEnter: function onEnter() {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(texts, {
            y: 0,
            autoAlpha: 1,
            stagger: 0.2,
            duration: 1,
...
function scroll() {
  var headerHeight = document.querySelector('header').offsetHeight + 20; // 固定ヘッダーの高さ（＋余白の追加）
...
function slide() {
  window.addEventListener('DOMContentLoaded', function () {
    ...
    if (document.querySelector(".js-slide")) {
      var _Splide;
      new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__.Splide(".js-slide", (_Splide = {
        type: "loop",
        gap: "1rem",
        //   perPage: 4,
        ...
        focus: 0,
        speed: 3500
      }, (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_Splide, "focus", "center"), (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_Splide, "updateOnMove", true), (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_Splide, "classes", {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "textHover": () => (/* binding */ textHover)
/* harmony export */ });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var gsap_ScrollToPlugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap/ScrollToPlugin */ "./node_modules/gsap/ScrollToPlugin.js");
/* harmony import */ var gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! gsap/ScrollTrigger */ "./node_modules/gsap/ScrollTrigger.js");
...
function textHover() {
  window.addEventListener('DOMContentLoaded', function () {
    ...
    var splitTarget = document.querySelectorAll('.js-textHover');
    ...
    splitTarget.forEach(function (target) {
      ...
      var newTextBefore = "<div class='before'>" + newText + "</div>"; // beforeクラスをつけた要素を生成
      var newTextAfter = "<div class='after'>" + newText + "</div>"; // afterクラスをつけた要素を生成
    ...
    splitTarget.forEach(function (target) {
      if (!target.classList.contains('is-active')) {
        //is-activeクラスを持っていなかったら
        var beforeSpan = target.querySelector('.before').querySelectorAll('span');
        var afterSpan = target.querySelector('.after').querySelectorAll('span');
        target.addEventListener('mouseenter', function () {
          //マウスが進入したら
          gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(beforeSpan, {
            y: '-150%',
            stagger: .05,
            ease: "power2.out"
          });
          gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(afterSpan, {
            y: '0%',
            stagger: .05,
            ease: "power2.out"
          });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "wipeAnimation": () => (/* binding */ wipeAnimation)
/* harmony export */ });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var gsap_all__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap/all */ "./node_modules/gsap/CustomEase.js");
...
function wipeAnimation() {
  window.addEventListener('DOMContentLoaded', function () {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_all__WEBPACK_IMPORTED_MODULE_1__.CustomEase, gsap_all__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger);

    // easeの定義
    gsap_all__WEBPACK_IMPORTED_MODULE_1__.CustomEase.create("custom", "0.48,-0.02,0,0.85");

    // .js-wipeAnimation 要素のセレクタを取得して、それぞれにアニメーションを設定
    document.querySelectorAll('.js-wipeAnimation').forEach(function (element) {
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _animation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_animation */ "./js/_animation.js");
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_header */ "./js/_header.js");
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_common */ "./js/_common.js");
/* harmony import */ var _scroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_scroll */ "./js/_scroll.js");
/* harmony import */ var _wipeAnimation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./_wipeAnimation */ "./js/_wipeAnimation.js");
...
/* harmony import */ var _contactFrom__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./_contactFrom */ "./js/_contactFrom.js");
/* harmony import */ var _slide__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./_slide */ "./js/_slide.js");
...
(0,_slide__WEBPACK_IMPORTED_MODULE_10__.slide)();
(0,_contactFrom__WEBPACK_IMPORTED_MODULE_9__.contactFrom)();
...
(0,_wipeAnimation__WEBPACK_IMPORTED_MODULE_4__.wipeAnimation)();
(0,_scroll__WEBPACK_IMPORTED_MODULE_3__.scroll)();
(0,_common__WEBPACK_IMPORTED_MODULE_2__.common)();
(0,_header__WEBPACK_IMPORTED_MODULE_1__.header)();
(0,_animation__WEBPACK_IMPORTED_MODULE_0__.animation)();
})();
