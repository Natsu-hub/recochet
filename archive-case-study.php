                        ...
                        <li class="p-case-study__item c-card">
                            <a href="<?php the_permalink(); ?>">
                                ...
                                <div class="c-card__content">
                                    <div class="c-card__company"><?php echo esc_html($case_company); ?></div>
                                    <div class="c-card__detail">
                                        <dl class="c-card__industry">
                                            <dt>業種</dt>
                                            <dd><?php echo esc_html($case_industry); ?></dd>
                                        </dl>
                                        <dl class="c-card__number">
                                            <dt>従業員数</dt>
                                            <dd><?php echo esc_html($case_number); ?></dd>
                                        </dl>
                                        <dl class="c-card__task">
                                            <dt>課題</dt>
                                            <dd><?php echo esc_html($case_task); ?></dd>
                                        </dl>
                                    </div>
                                </div>
                            </a>
