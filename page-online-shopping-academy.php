                    ...
                    <li class="p-service-flow__item">
                        ...
                        <div class="p-service-flow__box">
                            <picture class="p-service-flow__img">
                                <source
                                    srcset="<?php echo get_template_directory_uri(); ?>/assets/images/below/flow_img09.webp"
                                    type="image/webp">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/below/flow_img09.png"
