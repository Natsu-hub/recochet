        ...
        <ul class="p-service__list p-service-list">
          <li class="p-service-list__item trigger-effect">
            ...
            <div class="p-service-list__item-wrap">
                ...
                <p class="p-service-list__item-text js-fadeInSlow">【アドフューチャー】は、就労継続支援A型事業所・就労継続支援B型事業所という障がいのある方に就労の機会を提供する事業です。「脱福祉作業所」をコンセプトに、明るく開放的な環境で、様々な仕事を通じて適正を見つけ、より高い収入を目指してキャリアアップできる仕組みにより、就労意欲の高い集団で稼げる事業所を目指します。</p>
          ...
          <li class="p-service-list__item">
            ...
            <div class="p-service-list__item-wrap js-fadeIn">
              ...
              <p class="p-service-list__item-text">高齢者向け配食サービス【問屋町食堂】を運営しています。就労継続支援事業所で働く方々とともに、栄養バランスや味付けを尊重した「美味しい弁当」をご提供しています。ご利用者さま一人ひとりに満足してお召し上がりいただけるよう、いただいたご要望を取り入れながら季節に合わせた献立を作成します。</p>
              <div class="p-service-list__btn"><a class="c-btn-white" href="https://tonyashokudo.saporuto.com" target="_blank" rel="noopener noreferrer">
